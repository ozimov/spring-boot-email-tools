...
public class TemplatingTestUtils {
    ...
    public static final String TEMPLATE_IN_SUBFOLDER = "subfolder/email_template_in_subfolder.ftl";
    ...
    public static String getExpectedBody() throws IOException, URISyntaxException {
        final File file = new File(FreemarkerTemplateServiceTest.class.getClassLoader()
