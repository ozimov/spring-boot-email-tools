...
## Dependency
Latest release is **`0.5.2`**. To use the core module, you can import the following dependency in Maven
...
The library supports email scheduling, but since version _0.5.2_ the scheduler is disabled by default. To enable 
...
## Persistence
Persistence has been introduced in version `0.5.2`. Persistence is mainly of interest if the scheduler is used, therefore
