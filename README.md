...
## Dependency
Latest release is **`0.6.1`**. To use the core module, you can import the following dependency in Maven
...
The library supports email scheduling, but since version _0.6.1_ the scheduler is disabled by default. To enable 
