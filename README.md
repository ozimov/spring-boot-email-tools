...
## Dependency
Latest release is **`0.5.3`**. To use the core module, you can import the following dependency in Maven
...
The library supports email scheduling, but since version _0.5.3_ the scheduler is disabled by default. To enable 
